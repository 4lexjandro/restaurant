...
export function Lights() {
  return (
    <>
      <spotLight color="#670606" position={[-10, -10, -10]} intensity={0.2} />
      <spotLight color="#670606" position={[-10, 0, 15]} intensity={0.8} />
      <spotLight color="#670606" position={[-5, 20, 2]} intensity={0.5} />
      <spotLight color="#5C0202" position={[15, 10, -2]} intensity={2} />
      <spotLight color="#5C0202" position={[15, 10, 5]} intensity={1} />
      <spotLight color="#716D02" position={[5, -10, 5]} intensity={0.8} />
    </>
  );
}
...
export function Material() {
  return <meshPhongMaterial color="#fff" specular="#670606" shininess={10} />;
}
